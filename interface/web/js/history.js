...
function renderDashboardCaseList(preloadedCases) {
    ...
    const html = filteredCases.map(c => {
        ...
        <div class="dashboard-case-item ${selectedCases.has(c.id) ? 'selected' : ''}" data-id="${safeId}">
            <input type="checkbox" class="case-checkbox" data-case-id="${safeId}" ${selectedCases.has(c.id) ? 'checked' : ''}>
            <div class="case-info">
            ...
            <button class="case-delete" data-action="delete-dashboard-case" data-case-id="${safeId}" title="Delete case">
    ...
    const html = cases.map(c => {
        ...
        return `
            <tr>
                ...
                <td>
                    <button class="case-delete" data-action="delete-dashboard-case" data-case-id="${safeId}" title="Delete">
